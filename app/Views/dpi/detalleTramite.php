                ...
                <div class="card-body p-2">
                    <div class="pdf-container">
                        <iframe 
                            id="pdfViewer" 
                            class="pdf-viewer"
                            src="<?= base_url('dpi/documentos/verTesis/'.$fileTesis) ?>"
                            title="Visor de PDF">
                        </iframe>
                    </div>
                </div>
                            ...
                            <!-- Selector de documento -->
                                <div class="mb-4">
                                    ...
                                    <select id="documentSelect" class="form-select form-select-lg">
                                        <option value="<?= base_url('dpi/documentos/verTesis/'.$fileTesis) ?>" selected>
                                            <i class="fas fa-book"></i> Tesis Principal
                                        </option>
                                        <option value="<?= base_url('dpi/documentos/verDeclaracionJurada/'.$fileDeclaracionJuradaTramite) ?>">
                                            Declaración Jurada
                                        </option>
                                        <option value="<?= base_url('dpi/documentos/verAutorizacionPublicacion/'.$fileAutorizacionPublicacionTramite) ?>">
