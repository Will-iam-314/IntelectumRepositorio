...
<div id="container-Auth-2">
    ...
    <div class="mt-3">
        ...
        <p class="mt-2" style="text-align: justify;">
            Hemos eviado un código de verificación a tu correo electrónico, ingresalo a continuacion.
        </p>
        
        <form method="POST" action="<?= base_url('verificarRecuperacion')?>" autocomplete="off" onsubmit= "mostrarLoading()">
